...
class TestUrbanRoutes:
    ...
    def test_set_route(self):
        ...
        TestUrbanRoutes.routes_page = routes_page
    ...
    def test_select_comfort_tariff(self):
        ...
        assert self.routes_page.is_comfort_tariff_selected()
    ...
    def test_fill_card(self):
        ...
        assert self.routes_page.get_linked_card_value() != ''
    ...
    def test_order_blanket_and_tissues(self):
        ...
        assert self.routes_page.is_blanket_and_tissues_ordered()
